...
type Config struct {
	...
	StrategiesCount                   int       `env:"STRATEGIES_COUNT" envDefault:"300"`
	...
	StopLossMarkForRemovalSlack       []float64 `env:"STOP_LOSS_MARK_FOR_REMOVAL_SLACK" envDefault:"0.2,0.1,0.05,0.01"`
}
